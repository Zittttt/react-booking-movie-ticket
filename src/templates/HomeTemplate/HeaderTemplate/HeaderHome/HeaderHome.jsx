      ...
      <div className="flex justify-between h-12 w-full  text-base">
        ...
        <ul className="items-stretch hidden space-x-3 lg:flex">
          <li className="flex">
            <NavLink
              to="/home"
              className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent font-[900] text-black"
              activeClassName="text-dark-purple dark:border-violet-400"
            >
              Home
            </NavLink>
          </li>
        ...
        <div className="items-center flex-shrink-0 hidden lg:flex">
          <NavLink
            to={"/login"}
            className="self-center px-8 py-3 rounded bg-light-purple text-[#191e32]"
          >
            Login
          </NavLink>
          <NavLink
            to={"/register"}
            className="self-center px-8 py-3 font-semibold rounded bg-purple ml-3 dark:text-coolGray-900 text-[#191e32]"
          >
            Register
          </NavLink>
        </div>
